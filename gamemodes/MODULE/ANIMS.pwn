...
CMD:animcmds(playerid, params[])
{
    ...
    "{FF6347}[ANIMATION]:{FFFFFF} /handsup, /bat, /slapp, /bar, /wash, /lay, /workout, /blowjob, /bomb.\n{FF6347}[ANIMATION]:{FFFFFF} /carry, /crack, /slep, /jump, /deal, /dancing, /eating, /puke, /gsign, /chat.\n{FF6347}[ANIMATION]:{FFFFFF} /goggles, /spray, /throw, /swipe, /office, /kiss, /knife, /cpr, /scratch, /point.\n{FF6347}[ANIMATION]:{FFFFFF} /cheer, /wave, /strip, /smoke, /reload, /taichi, /wank, /hide, /drunk.\n{FF6347}[ANIMATION]:{FFFFFF} /cry, /tired, /sit, /crossarms, /fucku, /walk, /piss, /stopanim.");


    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, "{00FF00}Animation Commands", string, "Close", "");
    return 1;
}
...
CMD:smoke(playerid, params[])
{
    ...
    switch (type) {
        case 1:
            ...
            // Tambahkan objek rokok ke tangan pemain
        ...
        case 3:
            ...
            // Tambahkan objek rokok ke tangan 19897
...
CMD:laugh(playerid, params[])
{
    ...
    ApplyAnimation(playerid, "ON_LOOKERS", "laugh_01", 4.1, 0, 0, 0, 0, 0, 1);
    return 1;
}

CMD:sneeze(playerid, params[])
{
    if (!AnimationCheck(playerid))
        return Error(playerid, "You can't perform animations at the moment.");

    ApplyAnimation(playerid, "ON_LOOKERS", "shout_02", 4.1, 0, 0, 0, 0, 0, 1);
    return 1;
}
...
CMD:surrender(playerid, params[])
{
    ...
    ApplyAnimation(playerid, "PED", "handsup_loop", 4.1, 1, 0, 0, 0, 0, 1);
    return 1;
}
...
CMD:pushup(playerid, params[])
{
    ...
    ApplyAnimation(playerid, "GYMNASIUM", "gym_pushup", 4.1, 1, 0, 0, 0, 0, 1);
    return 1;
}
...
CMD:salute(playerid, params[])
{
    ...
    ApplyAnimation(playerid, "PED", "cop_talk_loop", 4.1, 0, 0, 0, 0, 0, 1);
    return 1;
}

CMD:sitcross(playerid, params[])
{
    if (!AnimationCheck(playerid))
        return Error(playerid, "You can't perform animations at the moment.");
...
CMD:jumpclap(playerid, params[])
{
    if (!AnimationCheck(playerid))
        return Error(playerid, "You can't perform animations at the moment.");

    ApplyAnimation(playerid, "DANCING", "DAN_Up_A", 4.1, 1, 0, 0, 0, 0, 1);
    return 1;
}
